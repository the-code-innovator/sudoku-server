...
You can report bugs and feature requests to [GitHub Issues](https://github.com/the-code-innovator/sudoku-server/issues). As mentioned please look for a similar existing issue before submitting a new one.
Label issues with the corrsponding [labels](https://github.com/the-code-innovator/sudoku-server/labels)
